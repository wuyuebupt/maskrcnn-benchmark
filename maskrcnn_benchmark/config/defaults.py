...
_C.MODEL.ROI_BOX_HEAD.POOLER_MAP_LEVEL_CONV = [0, 28, 56, 112, 1000]
_C.MODEL.ROI_BOX_HEAD.POOLER_MAP_LEVEL_FC = [0, 28, 56, 112, 1000]
_C.MODEL.ROI_BOX_HEAD.CONV_FC_THRESHOLD = [0, 28, 56, 112, 1000]
