...
if __name__ == '__main__':
  ...
  for i in range(iou_after_nms.shape[0]):
    print (iou_after_nms[i])
    print (prob_after_nms[i])
  ...
  sio.savemat(filename+'_statistic.mat', {'thres': thres, 'cls_min':cls_min, 'cls_max': cls_max, 'cls_median': cls_median, 'cls_mean':cls_mean, 'cls_std': cls_std, 'cls_bincount':cls_bincount})
