...
if __name__ == '__main__':
  ...
  sio.savemat(filename+'_statistic.mat', {'thres': thres, 'cls_min':cls_min, 'cls_max': cls_max, 'cls_median': cls_median, 'out_min':out_min, 'out_max':out_max, 'out_median': out_median, 'cls_mean':cls_mean, 'cls_std': cls_std, 'out_mean': out_mean, 'out_std': out_std})
