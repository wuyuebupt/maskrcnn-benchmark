...
def assign_map_type(aps, line):
  ...
  class_gt = int(line.split('_')[6]) - 1
  # print (class_gt)
  # print (class_gt in sorted_index[27:27+27])
  # exit()

  if class_gt in sorted_index[:27]:
        # print (1, sorted_index[:27])
        return 1
  elif class_gt in sorted_index[27:27+27]:
        # 3 print (2, sorted_index[27:27+27])
        return 2
  elif class_gt in sorted_index[27+27:]:
        # print (3, sorted_index[:27])
        return 3
  else:
        print ("error")
        return -1
...
if __name__ == '__main__':
  ...
  aps = sio.loadmat('sorted_class_index.mat')
  print (aps)
  sorted_index = aps['sorted_index'].reshape(-1).tolist()
  print (sorted_index)
  # exit()
  # aps = sio.loadmat('sorted_class_index.mat')['sorted_index']
  ...
  for line in lines:
    ...
    type_ = assign_map_type(sorted_index, line)
