...
python tools/train_net.py --config-file configs/e2e_faster_rcnn_R_50_C4_1x_neighbor.yaml  --output-dir /work/maskrcnn/iccv19/model_output_tmp/ --pretrained-model ../../R-50.pkl --data-dir ../maskrcnn-benchmark-file/datasets/ --nonlocal-num-group 1 --nonlocal-num-stack 0 --bbox-expand  1.2
